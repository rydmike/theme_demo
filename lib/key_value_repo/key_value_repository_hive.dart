...
/// A [KeyValueRepository] implementation that stores and retrieves key-value
/// pairs locally using the package Hive: https://pub.dev/packages/hive
class KeyValueRepositoryHive implements KeyValueRepository {
  KeyValueRepositoryHive(this.boxName);
  ...
  /// [KeyValueRepositoryHive]'s init implementation. Must be called before
  ...
  /// [KeyValueRepositoryHive] implementation may close its box if so desired
  ...
  /// Loads a setting from the [KeyValueRepositoryHive], using a key to access
  ...
  /// Save a setting to the [KeyValueRepositoryHive] with the Hive storage box,
