...
class KeyValueRepositoryPrefs implements KeyValueRepository {
  ...
  /// [KeyValueRepositoryPrefs] implementation needs no dispose.
  @override
  Future<void> dispose() async {}

  // Loads a setting from the data source, using a key to access it from
  ...
  // Save a setting to the key-value data source with the SharedPreferences
