...
class SurfaceStyleSwitch extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final FlexSurfaceMode mode = ref.watch(surfaceModeProvider);
    ...
    return ToggleButtons(
      ...
      onPressed: (int newIndex) {
        ref.read(surfaceModeProvider.state).state =
            FlexSurfaceMode.values[newIndex];
      },
      children: <Widget>[
        const Tooltip(
          message: 'Flat\nall at same level',
